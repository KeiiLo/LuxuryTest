 ...
 * {@link cirage.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link cirage#newInstance} factory method to
 * create an instance of this fragment.
 */
public class cirage extends Fragment implements  View.OnClickListener{
    ...
    public static cirage newInstance() {
        cirage fragment = new cirage();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_cirage, container, false);
        //Barre de navigation en bas
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            ...
            case R.id.imageButton_plus:
                fragmentManager.beginTransaction()
                        .replace(R.id.container, cirage_techniques.newInstance())
                        .commit();
                break;
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        public void onCirageFragmentInteraction(String string);
    }
