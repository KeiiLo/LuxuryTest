 ...
 * {@link healthreport.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link healthreport#newInstance} factory method to
 * create an instance of this fragment.
 */
public class healthreport extends Fragment implements  View.OnClickListener{
    ...
    public static healthreport newInstance() {
        healthreport fragment = new healthreport();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_healthreport, container, false);
        //Barre de navigation en bas
    ...
    public interface OnFragmentInteractionListener {
        public void onHealthFragmentInteraction(String string);
    }
}
